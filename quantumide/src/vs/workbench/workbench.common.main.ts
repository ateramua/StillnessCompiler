...
import './services/quantumide/browser/quantumideChatContextOrchestrator.js';
import './services/quantumide/browser/quantumideSemanticIndexService.js';
import './services/quantumide/browser/quantumideLspSymbolIndexService.js';
import './services/quantumide/browser/quantumideWorkspaceSymbolIndexService.js';
import './services/quantumide/browser/quantumideInlineDiffService.js';
import './services/quantumide/browser/quantumideInlineEditorService.js';
import './browser/quantumideTreeSitter.contribution.js';
import './browser/quantumideMcpToolBridge.contribution.js';
import './services/quantumide/browser/quantumideDiffReviewService.js';
import './services/quantumide/browser/quantumidePlatformService.js';
import './services/quantumide/browser/quantumideCommandAuditService.js';
import './services/quantumide/browser/quantumidePluginSettingsService.js';
import './services/quantumide/browser/quantumideChatEditSessionService.js';
import './services/quantumide/browser/quantumideBackgroundIndexerService.js';
import './services/quantumide/browser/quantumideReplSessionService.js';
import './services/quantumide/browser/quantumideContextExpansionService.js';
import './services/quantumide/browser/quantumideContextHealthService.js';
import './services/quantumide/browser/quantumideErrorRecoveryService.js';
import './services/quantumide/browser/quantumideWorkspaceSnapshotService.js';
import './services/quantumide/browser/quantumideChatThreadStoreService.js';
import './services/quantumide/browser/quantumideWorkspaceStateService.js';
import './browser/quantumideWorkspaceState.contribution.js';
import './browser/quantumideWorkspaceRootsSync.contribution.js';
import './browser/quantumideWorkspaceDiscovery.contribution.js';
import './services/quantumide/browser/quantumideAgentTaskOrchestratorService.js';
import './browser/quantumideAgentTaskBridge.contribution.js';
import './services/quantumide/browser/quantumideContextInspectorService.js';
import './services/quantumide/browser/quantumideNavigationHistoryService.js';
import './services/quantumide/browser/quantumidePlatformOpsServices.js';
import './browser/quantumideProductionCompletion.contribution.js';
import './browser/quantumideCollaborationPresence.contribution.js';
import './services/quantumide/browser/quantumideProjectManagerService.js';
import './services/quantumide/browser/quantumideFileExplorerTreeService.js';
import './services/quantumide/browser/quantumideRefactorWorkflowService.js';
import './services/quantumide/browser/quantumideChatTestPanelService.js';
import './services/quantumide/browser/quantumideChatScmPanelService.js';
import './services/quantumide/browser/quantumideChatPluginMarketplaceService.js';
import './services/quantumide/browser/quantumideChatRichUiService.js';
import './services/quantumide/browser/quantumideOnboardingService.js';
import './services/quantumide/browser/quantumideFileNavigationService.js';
import './services/quantumide/browser/quantumideRecentlyViewedFilesService.js';
import './services/quantumide/browser/quantumideWorkspaceIgnoreService.js';
import './services/quantumide/browser/quantumideActiveEditorService.js';
import './services/quantumide/browser/quantumideCollaborationService.js';
import './services/quantumide/browser/quantumideChatInlineEditService.js';
import './browser/quantumideChatThreadTracker.contribution.js';
...
import './browser/quantumideChatPlatform.contribution.js';
import './browser/quantumideSettingsHub.contribution.js';
import './browser/quantumideSettingsPanel.contribution.js';
import './browser/quantumideSettingsPanelActions.contribution.js';
import './browser/quantumideArchitecture.contribution.js';
import './browser/quantumideKeybindings.contribution.js';
import './browser/quantumidePerformance.contribution.js';
import './browser/quantumideExtensibility.contribution.js';
import './browser/quantumideInlineDiff.contribution.js';
import './browser/quantumideChatParity.contribution.js';
import './browser/quantumidePluginClientTools.contribution.js';
import './browser/quantumideFeatureParity.contribution.js';
import './browser/quantumideCursorLevel.contribution.js';
import './browser/quantumideCursorParity.contribution.js';
import './browser/quantumidePdrFulfillment.contribution.js';
import './browser/quantumidePracticalPriority.contribution.js';
import './browser/quantumideNextBatch.contribution.js';
import './browser/quantumideChatPanelEightStep.contribution.js';
import './browser/quantumideAgentSevenRequirements.contribution.js';
import './browser/quantumideWorkflowOptimization.contribution.js';
import './browser/quantumideChatEightFeatures.contribution.js';
import './browser/quantumideCursorParitySix.contribution.js';
import './browser/quantumideCursorChatParityProgram.contribution.js';
import './browser/quantumideChatAgentActivity.contribution.js';
import './browser/quantumideChatPerf.contribution.js';
import './services/quantumide/browser/quantumideUnifiedEditPipelineService.js';
import './services/quantumide/browser/quantumideChatInThreadInjectService.js';
import './services/quantumide/browser/quantumideTerminalBlockService.js';
import './services/quantumide/browser/quantumideIndexerWorkerScheduler.js';
import './services/quantumide/browser/quantumideAgentStepGateService.js';
import './services/quantumide/browser/quantumideExecutionGraphService.js';
import './browser/quantumideChatAtMention.contribution.js';
import './browser/quantumideChatEditReviewOverlay.contribution.js';
import './services/quantumide/browser/quantumideCollabRelayService.js';
import './services/quantumide/browser/quantumideSecretScannerService.js';
import './browser/quantumideChatWorkflow.contribution.js';
import './browser/quantumideChatPanelParity.contribution.js';
import './browser/quantumideProduction.contribution.js';
import './browser/quantumideConfigurationDefaults.js';
import './browser/quantumideDeveloperTools.contribution.js';
import './browser/quantumideMenu.contribution.js';
import './browser/quantumideStatusBar.contribution.js';
import './browser/quantumideAgentTaskPhaseBridge.contribution.js';
import './browser/quantumideAgentTaskPhaseStatus.contribution.js';
