...
if (!args.supportGlobalNavigator) {
	Object.defineProperty(globalThis, 'navigator', {
		get: () => {
			onUnexpectedExternalError(new PendingMigrationError('navigator is now a global in nodejs, please see https://github.com/microsoft/vscode/issues/252077 for additional info on this error.'));
			return undefined;
		}
	});
}
