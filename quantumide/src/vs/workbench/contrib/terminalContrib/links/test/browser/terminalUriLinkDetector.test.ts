...
suite('Workbench - TerminalUriLinkDetector', () => {
	...
	const linkComputerCases: [
		...
		/* Stat resource  */ URI?
			...
			[TerminalBuiltinLinkType.Url, '// Click here to learn more. https://learn.microsoft.com/en-us/aspnet/core/client-side/using-grunt', [{ range: [[30, 1], [18, 2]], uri: URI.parse('https://learn.microsoft.com/en-us/aspnet/core/client-side/using-grunt') }]],
			[TerminalBuiltinLinkType.Url, '// Click here to learn more. https://learn.microsoft.com/en-us/windows/win32/fileio/naming-a-file', [{ range: [[30, 1], [11, 2]], uri: URI.parse('https://learn.microsoft.com/en-us/windows/win32/fileio/naming-a-file') }]],
			...
			[TerminalBuiltinLinkType.Url, '<!-- !!! Do not remove !!!   WebContentRef(link:https://learn.microsoft.com/en-us/azure/devops/server/command-line/tfsconfig-cmd, area:Admin, updated:2015, nextUpdate:2016, tags:SqlServer)   !!! Do not remove !!! -->', [{ range: [[49, 1], [48, 2]], uri: URI.parse('https://learn.microsoft.com/en-us/azure/devops/server/command-line/tfsconfig-cmd') }]],
			[TerminalBuiltinLinkType.Url, 'For instructions, see https://learn.microsoft.com/en-us/azure/devops/server/command-line/tfsconfig-cmd.</value>', [{ range: [[23, 1], [22, 2]], uri: URI.parse('https://learn.microsoft.com/en-us/azure/devops/server/command-line/tfsconfig-cmd') }]],
			[TerminalBuiltinLinkType.Url, 'For instructions, see https://learn.microsoft.com/en-us/windows/win32/fileio/naming-a-file.</value>', [{ range: [[23, 1], [4, 2]], uri: URI.parse('https://learn.microsoft.com/en-us/windows/win32/fileio/naming-a-file') }]],
			...
			[TerminalBuiltinLinkType.Url, '請參閱 https://code.visualstudio.com/docs/configure/locales。', [{ range: [[5, 1], [56, 1]], uri: URI.parse('https://code.visualstudio.com/docs/configure/locales') }]],
			[TerminalBuiltinLinkType.Url, '（請參閱 https://code.visualstudio.com/docs/configure/locales）', [{ range: [[6, 1], [57, 1]], uri: URI.parse('https://code.visualstudio.com/docs/configure/locales') }]],
			...
			[TerminalBuiltinLinkType.Url, '7. At this point, ServiceMain has been called.  There is no functionality presently in ServiceMain, but you can consult the [MSDN documentation](https://learn.microsoft.com/en-us/windows/win32/services/writing-a-servicemain-function) to add functionality as desired!', [{ range: [[66, 2], [63, 3]], uri: URI.parse('https://learn.microsoft.com/en-us/windows/win32/services/writing-a-servicemain-function') }]],
