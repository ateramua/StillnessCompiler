...
suite('promptsServiceUtils', () => {
	...
	suite('isOrganizationPromptFile', () => {
		const CHAT_EXTENSION_ID = 'quantumide.personal-chat';
		...
		test('extension ID comparison is case-insensitive', () => {
			...
			const extensionId = new ExtensionIdentifier('QUANTUMIDE.PERSONAL-CHAT');
			const productService = createProductService('quantumide.personal-chat');
