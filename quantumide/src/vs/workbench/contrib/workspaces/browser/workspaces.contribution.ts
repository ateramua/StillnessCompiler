	...
	private doHandleWorkspaceFiles(folder: URI, workspaces: string[]): void {
		...
		// Prompt to select a workspace from many
			...
			this.notificationService.prompt(Severity.Info, localize({
				key: 'foundWorkspaces',
				comment: ['{Locked="]({0})"}']
			}, "This folder contains multiple workspace files. Do you want to open one? [Learn more]({0}) about workspace files.", 'https://code.visualstudio.com/docs/editing/workspaces/multi-root-workspaces'), [{
