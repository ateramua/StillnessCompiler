...
const acknowledgementsLabel = escape(localize('acknowledgements', "I acknowledge that my editor version is not updated and this issue may be closed."));
const reviewGuidanceLabel = localize( // intentionally not escaped because of its embedded tags
	{
		key: 'reviewGuidanceLabel',
		comment: [
			'{Locked="<a href=\"https://github.com/ateramua/StillnessCompiler/blob/main/quantumide/README.md\" target=\"_blank\">"}',
			'{Locked="</a>"}'
		]
	},
	'Before you report an issue here please <a href="https://github.com/ateramua/StillnessCompiler/blob/main/quantumide/README.md" target="_blank">review project information and reporting tips</a>. Please complete the form in English.'
);
