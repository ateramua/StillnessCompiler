...
export const config = {
	...
	companyName: 'QuantumIDE (personal build)',
	copyright: 'Copyright (C) 2026 QuantumIDE personal fork. Based on VS Code OSS (MIT).',
	darwinExecutable: product.nameShort,
	darwinIcon: 'resources/darwin/quantumide.icns',
	darwinBundleIdentifier: product.darwinBundleIdentifier,
	darwinApplicationCategoryType: 'public.app-category.developer-tools',
	darwinHelpBookFolder: 'QuantumIDE HelpBook',
	darwinHelpBookName: 'QuantumIDE HelpBook',
	darwinBundleDocumentTypes: [
		...
		...darwinBundleDocumentTypes({
			...
			'QuantumIDE workspace file': 'code-workspace',
	...
	winIcon: 'resources/win32/quantumide.ico',
